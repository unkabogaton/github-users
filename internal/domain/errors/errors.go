...
// ErrorCode represents a stable machine-consumable error code for API clients.
...
// DomainError is a typed error that carries an ErrorCode and an optional cause.
